...
const CallToAction = () => {
    ...
    return (
        <section ref={sectionRef} className="p-5 md:px-8 bg-gradient-to-b from-white to-[#d2dcff] py-24 overflow-x-clip">
            <div className="container">
                <div className="section-heading relative">
                    <h2 className="section-title">Sign up for free today</h2>
                    <p className="section-description mt-5">
                        Celebrate the joy of accomplishent with an app designed to track your progress and motivate your efforts
                    </p>
                    <motion.img
                        src={starImage.src} alt='star'
                        width={360}
                        className='absolute -left-[350px] -top-[137px]'
                        style={{ translateY: translateY }}
                    />
                    <motion.img
                        src={springImage.src} alt='spring'
                        width={360}
